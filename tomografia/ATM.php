        ...
        <article class="container mt-5">
                    ...
                    <div class=" margin2  col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-5">
                        <div class="col-12 tarjeta-servicio">
                                <div class="video-container">
                                    <video class="video-pequeno" controls loop autoplay muted src="../assets/img/ATM/primervideo.mp4">
                                        <track src="captions.vtt" default kind="captions" srclang="es" label="Español (Latinoamérica)">
                                        Tu navegador no soporta video
                                    </video>
                                </div>
                                <div class="card-body">
                                    <h5 style="text-align:center;">Tomografía ATM</h5>
                                    <p class="card-text"></p>
                                </div> 
                        </div>
                    </div>
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-4 col-sm-6 col-xs-12 mb-5">
                    <div class="col-12 tarjeta-servicio">
                            <img class="card-img-top" src="../assets/img/ATM/huesos.jpeg" alt="Card image cap">
                        <div class="card-body">
                                <h5 style="text-align:center;">Tomografía ATM</h5>
                            <p class="card-text"></p>
                        </div> 
